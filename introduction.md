...
| Служба обработки заказов | СОЗ(С) | Служба обработки заказов. Система, которая принимает заказы с веб-приложения и проводит дальнейшую обработку. Является оркестратором процесса.           |
...
| Система продуктов | СП(С) | Система продуктов. Каталог товаров, доступный для выбора клиентам в веб-приложении.                                                                      |
...
| Артикул товара             | *   | integer           | Артикул товара | * | integer  |
| Название товара            |     | varchar [100]             | Название товара | | varchar [100]              |
| Стоимость                  | *   | numeric            | Стоимость продукта             | *   | numeric        |
| Количество на складе       |     | number            | Количество                     |     | number           |
| Единица измерения          |     | integer            | Единица измерения |     | integer |
| Статус товара              | *   | boolean [активный, неактивный] | Статус                    | *   | [1, 0]           |